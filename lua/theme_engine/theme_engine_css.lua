...
DarkThemeCSS.LoadingDark = [==[
body { background-color: #0f172a !important; color: #e2e8f0 !important; }
#background { background-color: #0f172a !important; }
#container { background: rgba(15,23,42,0.85) !important; border-color: rgba(255,255,255,0.07) !important; }
.server_info { background: rgba(15,23,42,0.9) !important; border-color: rgba(255,255,255,0.07) !important; }
.server_info .text #serverName { color: #f8fafc !important; }
.server_info .text #serverMap, .server_info .text #serverGamemode { color: #94a3b8 !important; }
.progressbar { background: rgba(30,41,59,0.8) !important; border: 1px solid rgba(59,130,246,0.35) !important; }
.progressbar > div { background: #3b82f6 !important; }
#progress_text { color: #94a3b8 !important; }
.walk { color: #60a5fa !important; }
]==]
